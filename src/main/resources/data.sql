...
INSERT INTO `answers` VALUES (1,_binary '','test','2019-06-03 00:00:00',1,2),(2,_binary '\0','Prepare yourself for being in the army!','2019-06-03 12:59:00',1,3);
...
CREATE TABLE `comments` (
  ...
  CONSTRAINT `FKoiwlwqmu9qm0tjnafxqr20rd8` FOREIGN KEY (`answer_id`) REFERENCES `answers` (`id`)
...
CREATE TABLE `feedbacks` (
  ...
  CONSTRAINT `FKkmb4xm2mu42sp99hn4o0v3knf` FOREIGN KEY (`teacher_id`) REFERENCES `teachers` (`id`)
...
INSERT INTO `feedbacks` VALUES (1,'The worst corrupted university in the whole universe',1,NULL,1),(2,'Not as bad as they say',3,NULL,1),(3,'Totally liked that!',5,NULL,1),(4,'So far so good.',4,NULL,2),(5,'To pass exam you need only 0.5 bottle of vodka. The funniest learning experience ever)',5,NULL,3),(6,'Don`t know what to say',2,NULL,4),(7,'As a lecturer he is the worst, but as a person he\'s good',3,1,NULL),(8,'bad_bad_bad_bad_bad_bad_bad bad_bad_bad_bad_bad_bad_bad_bad_bad',1,2,NULL),(9,'good',5,2,NULL),(10,'Sample text',4,4,NULL),(11,'Petuch',3,6,NULL);
...
CREATE TABLE `questions_tags` (
  ...
  CONSTRAINT `FK4u5xv906wfevngoe973bec6u0` FOREIGN KEY (`question_id`) REFERENCES `questions` (`id`),
...
INSERT INTO `teachers` VALUES (1,'2019-06-02 00:00:00','Bogdan',NULL,'Gnativ',NULL,1),(2,'2019-06-02 00:00:00','Petro',NULL,'Kostrobiy',NULL,1),(3,'2019-06-02 00:00:00','Petro',NULL,'Topulko',NULL,1),(4,'2019-06-02 00:00:00','Roman',NULL,'Kalyna',NULL,2),(5,'2019-06-02 00:00:00','Olexiy',NULL,'Pidlisnyi',NULL,2),(6,'2019-06-02 00:00:00','Oleg',NULL,'Petuchello',NULL,3),(7,'2019-06-02 00:00:00','Igor',NULL,'Kolega',NULL,4);
...
INSERT INTO `universities` VALUES (1,'Lviv','2019-06-01 00:00:00',NULL,NULL,'Lviv Polytechnic National University'),(2,'Lviv','2019-06-01 00:00:00',NULL,NULL,'Ivan Franko Lviv National University'),(3,'Lviv','2019-06-01 00:00:00',NULL,NULL,'Bursa'),(4,'Kyiv','2019-06-01 00:00:00',NULL,NULL,'Kyiv Polytechnic University');
...
INSERT INTO `users` VALUES (1,'2019-05-05','tarasgl@gmail.com','Taras',NULL,'Hlukhovetskyi','123','USER','tarasgl',NULL),(2,'2019-06-05','sample@gmail.com','Olha',NULL,'Lozinska','123','USER','olozh',NULL),(3,'2019-06-07','admin@gmail.com','Admin',NULL,'Admin','admin','ADMIN','admin',NULL),(4,'2019-06-08','sample2@gmail.com','Andrii',NULL,'Vashchenok','123','USER','avash',NULL);
...
CREATE TABLE `votes` (
  ...
  CONSTRAINT `FKruiggkp5t2k72ks0ojsyaj867` FOREIGN KEY (`feedback_id`) REFERENCES `feedbacks` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `votes` VALUES (1,1,2,NULL,2),(2,-1,1,NULL,2),(3,1,1,NULL,3),(4,-1,1,NULL,4);
...
-- Dump completed on 2019-06-10 18:37:08
