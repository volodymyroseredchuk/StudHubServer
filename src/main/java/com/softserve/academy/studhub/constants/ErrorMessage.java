...
public class ErrorMessage {
    ...
    public static final String USER_NOT_FOUND_BY_ID = "The user does not exist by this param2: ";
    ...
    public static final String QUESTION_NOTFOUND = "Requested question does not exist by this param2: ";
    public static final String ANSWER_NOTFOUND = "Requested answer does not exist by this param2: ";
    public static final String COMMENT_NOTFOUND = "Requested comment does not exist by this param2: ";
    public static final String TEACHER_NOTFOUND = "Requested teacher does not exist by this param2: ";
    public static final String UNIVERSITY_NOTFOUND = "Requested university does not exist by this param2: ";
    public static final String TAG_NOT_FOUND_BY_ID = "Requested tag does not exist by this param2: ";
    public static final String TAG_NOT_FOUND_BY_NAME = "Requested tag does not exist by this name: ";
    public static final String FEEDBACK_NOTFOUND = "Requested feedback does not exist by this param2: ";
    public static final String VOTE_NOTFOUND = "Requested vote does not exist by this param2: ";
